...
require_repo_text "README.zh-CN.md" 'StowPaste v0\.1\.2（中文 DMG）' 'Chinese README has a prominent localized download action'
require_repo_text "README.zh-CN.md" 'https://github\.com/TseringYuu/stowpaste/releases/download/v0\.1\.2/StowPaste-v0\.1\.2-zh-CN\.dmg' 'Chinese README links the published Chinese DMG'
...
require_repo_text "README.md" 'Download StowPaste v0\.1\.2 \(DMG\)' 'English README has a prominent versioned download action'
require_repo_text "README.md" 'https://github\.com/TseringYuu/stowpaste/releases/download/v0\.1\.2/StowPaste-v0\.1\.2\.dmg' 'English README links the published release DMG'
