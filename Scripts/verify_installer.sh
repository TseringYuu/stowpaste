...
require_file_source "$BUILD_INSTALLER" 'APP_VERSION="0\.1\.2"' 'installer artifact has a predictable 0.1.2 pkg name'
require_file_source "$BUILD_INSTALLER" 'PKG_VERSION="0\.1\.2"' 'installer package version matches the 0.1.2 release'
