...
require_file "public/downloads/StowPaste-v0.1.2.dmg" "current DMG download artifact"
require_file "public/downloads/StowPaste-v0.1.2.dmg.sha256" "current DMG checksum"
require_file "public/downloads/StowPaste-v0.1.2-zh-CN.dmg" "current Chinese DMG download artifact"
require_file "public/downloads/StowPaste-v0.1.2-zh-CN.dmg.sha256" "current Chinese DMG checksum"
if [[ -e "$WEBSITE_PACKAGE_DIR/public/downloads/StowPaste-v0.1.2.pkg" ]]; then
